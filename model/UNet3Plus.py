...
class UNet3Plus(nn.Module):
    def __init__(self, in_channels=3, out_channels=1):
        ...
        self.final_conv = nn.Conv2d(self.UpChannels, out_channels, 1)

    def forward(self, x):

        ## encoder
        h1 = self.encoder1(x)  # 320*320
        h2 = self.encoder2(self.maxpool(h1))  # 160*160
        h3 = self.encoder3(self.maxpool(h2))  # 80*80
        h4 = self.encoder4(self.maxpool(h3))  # 40*40
        hd5 = self.encoder5(self.maxpool(h4))  # 20*20
